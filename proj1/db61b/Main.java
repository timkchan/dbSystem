...
public class Main {
    ...
    /**
     * Starting with an empty database, read and execute commands from System.in
     * until receiving a 'quit' ('exit') command or until reaching the end of
     * input.
     */
    public static void main(String[] unused) {
        ...
        CommandInterpreter interpreter = new CommandInterpreter(db,
                input, System.out);
